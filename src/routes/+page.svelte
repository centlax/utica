								...
								<div class="sm:flex-1">
									...
									<div class="mt-5 flex flex-wrap space-y-3 sm:space-x-3 sm:space-y-0">
										<UElement
											as="close"
											this="div"
											class="inline-flex w-full shrink-0 items-center justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 sm:flex-1"
										>
											Message
										</UElement>
										<button
						...
						<dl class="space-y-8 px-4 sm:space-y-6 sm:px-6">
							<div>
								...
								<dd class="mt-1 text-sm text-gray-900 sm:col-span-2">
									<p>
										Enim feugiat ut ipsum, neque ut. Tristique mi id elementum praesent. Gravida in
