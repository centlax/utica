<script lang="ts">
	import { UHeader, UFooter, UHeaderItem, UHeaderMenu, UTooltip } from '$lib/index.js';
...
<section
	class="mx-auto flex h-screen w-full max-w-screen-2xl flex-col items-center justify-between p-6 lg:px-8"
>
	<UHeader>
		{#each links as link}
			{#if link.links}
