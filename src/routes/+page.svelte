<script lang="ts">
	import { UButton, UCombobox, UHeading, USheet, UToggle } from '$lib/index.js';
	let open: boolean = $state(false)
</script>

<section class="flex h-screen w-screen flex-col overflow-hidden bg-white px-8 text-gray-900">

	<USheet transition={{x: "-100%"}} bind:value={open}>
			<UButton onclick={()=> open =! open} class="text-neutral-900" about="open sheet" />
