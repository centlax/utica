...
<div class="relative mt-10 overflow-auto rounded-xl p-8">
	<div
		class="grid grid-flow-row grid-cols-3 gap-4 rounded-lg bg-red-500 text-center font-mono text-sm font-bold leading-6 text-white"
	>
		<div
...
{#if show}
	<div class="relative isolate hidden pt-14">
		<svg
		...
		>
			<div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
				<div class="flex">
					<div
						class="relative flex items-center gap-x-4 rounded-full bg-white px-4 py-1 text-sm/6 text-neutral-600 ring-1 ring-neutral-900/10 hover:ring-neutral-900/20"
					>
						<span class="font-semibold text-indigo-600">We’re hiring</span>
						<span class="h-4 w-px bg-neutral-900/10" aria-hidden="true"></span>
						<a href="/" class="flex items-center gap-x-1">
							<span class="absolute inset-0" aria-hidden="true"></span>
							See open positions
							<svg
								class="-mr-2 size-5 text-neutral-400"
								viewBox="0 0 20 20"
								fill="currentColor"
								aria-hidden="true"
								data-slot="icon"
				...
				<h1
					class="mt-10 text-pretty text-5xl font-semibold tracking-tight text-neutral-900 sm:text-7xl"
				>
	...
	<div class="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
		<div
			class="relative isolate overflow-hidden bg-neutral-900 px-6 py-20 sm:rounded-3xl sm:px-10 sm:py-24 lg:py-24 xl:px-24"
		>
			<div
			...
			>
				<div class="lg:row-start-2 lg:max-w-md">
					...
					<p class="mt-6 text-lg/8 text-neutral-300">
				...
				>
					<dl class="max-w-xl space-y-8 text-base/7 text-neutral-300 lg:max-w-none">
						<div class="relative">
	...
	<div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
		<div class="mx-auto max-w-2xl lg:text-center">
			...
			<p
				class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-neutral-900 sm:text-5xl lg:text-balance"
			>
		...
		<div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
			<dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
				<div class="flex flex-col">
					<dt class="flex items-center gap-x-3 text-base/7 font-semibold text-neutral-900">
						<svg
					...
					<dd class="mt-4 flex flex-auto flex-col text-base/7 text-neutral-600">
						<p class="flex-auto">
	...
	<div class="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
		...
		>
			...
			<p class="mx-auto mt-6 max-w-lg text-center text-lg text-neutral-300">
			...
			<form class="mx-auto mt-10 flex max-w-md gap-x-4">
				...
				<input
					...
					autocomplete="email"
					required
					class="min-w-0 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm/6"
					placeholder="Enter your email"
				/>
				<button
					type="submit"
					class="flex-none rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-neutral-900 shadow-sm hover:bg-neutral-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
					>Notify me</button
				>
			</form>
			<svg
	...
	<div class="relative isolate mt-32 sm:mt-56 sm:pt-32">
		<svg
			class="absolute inset-0 -z-10 hidden size-full stroke-neutral-200 [mask-image:radial-gradient(64rem_64rem_at_top,white,transparent)] sm:block"
			aria-hidden="true"
		>
			<defs>
				<pattern
			...
			<svg x="50%" y="0" class="overflow-visible fill-neutral-50">
				<path
		...
		<div class="relative">
			...
			<div class="mx-auto max-w-7xl px-6 lg:px-8">
				<div class="mx-auto max-w-2xl sm:text-center">
					...
					<p
						class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-neutral-900 sm:text-balance sm:text-5xl"
					>
						We have worked with thousands of amazing people
					</p>
				</div>
				<div
					class="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm/6 text-neutral-900 sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4"
				>
					<figure
						class="col-span-2 hidden sm:block sm:rounded-2xl sm:bg-white sm:shadow-lg sm:ring-1 sm:ring-neutral-900/5 xl:col-start-2 xl:row-end-1"
					>
						<blockquote class="p-12 text-xl/8 font-semibold tracking-tight text-neutral-900">
							<p>
						...
						<figcaption class="flex items-center gap-x-4 border-t border-neutral-900/10 px-6 py-4">
							<img
								class="size-10 flex-none rounded-full bg-neutral-50"
								src="https://images.unsplash.com/photo-1550525811-e5869dd03032?ixlib=rb-=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=1024&h=1024&q=80"
								alt=""
							/>
							<div class="flex-auto">
								<div class="font-semibold">Brenna Goyette</div>
								<div class="text-neutral-600">@brennagoyette</div>
							</div>
							<img
							...
							<figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-neutral-900/5">
								...
								<figcaption class="mt-6 flex items-center gap-x-4">
									...
									<div>
										...
										<div class="text-neutral-600">@lindsaywalton</div>
									</div>
								</figcaption>
							</figure>
							...
							<figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-neutral-900/5">
								...
								<figcaption class="mt-6 flex items-center gap-x-4">
									...
									<div>
										...
										<div class="text-neutral-600">@tomcook</div>
									</div>
								</figcaption>
							</figure>
							...
							<figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-neutral-900/5">
								...
								<figcaption class="mt-6 flex items-center gap-x-4">
									...
									<div>
										...
										<div class="text-neutral-600">@leonardkrasner</div>
									</div>
								</figcaption>
							</figure>
